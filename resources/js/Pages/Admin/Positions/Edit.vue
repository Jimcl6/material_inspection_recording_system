        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="mt-2 text-2xl font-semibold text-gray-900">Edit Position</h1>
                    <p class="text-sm text-gray-600">{{ position.users_count || 0 }} users assigned</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <!-- Permissions -->
                    <div class="bg-white rounded-lg shadow p-6">
                        <h2 class="text-lg font-medium text-gray-900 mb-4">Position Permissions</h2>
                        <p class="text-sm text-gray-600 mb-4">Select permissions that users with this position will have.</p>
