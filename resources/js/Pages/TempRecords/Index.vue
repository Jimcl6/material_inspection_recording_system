<template>
  <div class="container py-4">
    <div class="d-flex align-items-center justify-content-between mb-3">
      <h1 class="h3 m-0">Temperature Records</h1>
                ...
                <td class="text-end">
                  <div class="dropdown dropup d-inline-block position-static">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li><a class="dropdown-item" :href="`/temp-records/${r.id}`">View</a></li>
                      <li><a class="dropdown-item" :href="`/temp-records/${r.id}/edit`">Edit</a></li>
...
function destroy(id) {
  ...
  router.post(`/temp-records/${id}`, { _method: 'delete', _token: csrf }, { preserveScroll: true })
}
</script>
