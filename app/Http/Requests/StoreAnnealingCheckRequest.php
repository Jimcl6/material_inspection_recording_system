...
class StoreAnnealingCheckRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'supplier_lot_number' => 'required|string|max:100',
            'quantity' => 'required|integer|min:1',
            'annealing_date' => 'required|date|after_or_equal:receiving_date',
            ...
            'temperature_readings' => 'required|array|min:1',
